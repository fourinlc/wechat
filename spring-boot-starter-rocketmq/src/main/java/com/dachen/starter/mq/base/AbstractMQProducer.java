package com.dachen.starter.mq.base;

import com.dachen.starter.mq.MQException;
...
public abstract class AbstractMQProducer {
     ...
     * @throws MQException 消息异常
     */
    public SendResult syncSendOrderly(Message message, String hashKey) throws MQException {
